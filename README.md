...
9. agg 'time(10s, 5m, 30m, 2h, etc.)' <- This is the long-running aggregator service. Sends requests at a given time interval to feeds, collecting posts in database. ->
